...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	Button viewTotalAttendance, logout;
	Spinner spinnerbranch,spinneryear,spinnerSubject;
	String branch = "Course Code";
	String year = "Semester";
	String subject = "Subject Code";

	private String[] branchString = new String[] {"CS240", "CS259", "CS230"};
	private String[] yearString = new String[] {"1","2","3","4","5","6","7"};
	...
	private String[] subjectFinal = new String[] {"ICT602","ICT600","DSC650","DSC551","CSP600","ICT606"};
